...
const collection = firestore.collection('jerseys');
...
export const create = async (data) => {
  const ref = await collection.add({ ...data, isActive: true, createdAt: admin.firestore.FieldValue.serverTimestamp(), updatedAt: admin.firestore.FieldValue.serverTimestamp() });
